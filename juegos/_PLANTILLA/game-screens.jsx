// game-screens.jsx — PLANTILLA (Estudios Sociales) · FORMATO EDINUN completo.
// Mecánica "Mira y toca" (ref: edinun-ccn-games/juego-1):
// HUD (logo + RONDA con dots + tiempo + estrellas), personaje guía con bocadillo
// de pista, cartel central con emoji, opciones tipo ficha candy, overlay de
// feedback "¡EXCELENTE!/¡UPS!" y ResultsScreen tipo reporte académico imprimible.
//
// El niño TOCA la opción correcta directamente (no hay VERIFICAR/BORRAR).
// Cada partida son ROUNDS rondas elegidas al azar de un banco, evitando las
// vistas recientemente (localStorage) → recargar o cambiar de niño NO repite.
//
...
//
// PARA CREAR UN JUEGO: reemplaza CAT_LABEL, RECENT_KEY y el banco PREGUNTAS por
// el contenido real. Formato de ítem:
//   { ctx: "emoji", enunciado, pista, opciones:[{e:"emoji",t:"texto"}], correcta }
...
const CAT_LABEL = "Estudios Sociales";   // ← PERSONALIZAR: tema del juego
const ROUNDS = 4;

// ─────────────────────────────────────────────────────────────
// Banco de preguntas DEMO — Estudios Sociales. REEMPLAZAR por el contenido real.
// { ctx: emoji de contexto, enunciado, pista (bocadillo, sin emoji),
//   opciones:[{e,t}], correcta: idx }. Posición de la correcta variada.
// ─────────────────────────────────────────────────────────────
const PREGUNTAS = [
  { ctx: "🧭", enunciado: "¿Qué usamos para orientarnos y hallar el Norte?", pista: "Su aguja siempre señala el Norte.",
    opciones: [{ e: "🕐", t: "Reloj" }, { e: "🧭", t: "Brújula" }, { e: "📏", t: "Regla" }], correcta: 1 },
  { ctx: "🗺️", enunciado: "¿Cómo se llama el dibujo de un lugar visto desde arriba?", pista: "Sirve para ubicar ciudades, ríos y montañas.",
    opciones: [{ e: "🗺️", t: "Mapa" }, { e: "📷", t: "Foto" }, { e: "🖼️", t: "Cuadro" }], correcta: 0 },
  { ctx: "👪", enunciado: "¿Cuál es nuestro primer grupo social?", pista: "Es tu grupo más cercano, en casa.",
    opciones: [{ e: "🏫", t: "Escuela" }, { e: "🏭", t: "Trabajo" }, { e: "👪", t: "Familia" }], correcta: 2 },
  { ctx: "🏛️", enunciado: "¿Quién dirige el gobierno de una ciudad?", pista: "Trabaja en el municipio.",
    opciones: [{ e: "👨‍🏫", t: "Maestro" }, { e: "👨‍⚕️", t: "Médico" }, { e: "🧑‍💼", t: "Alcalde" }], correcta: 2 },
  { ctx: "🌅", enunciado: "La línea donde el cielo se junta con la tierra es el…", pista: "La ves a lo lejos, muy recta.",
    opciones: [{ e: "🌅", t: "Horizonte" }, { e: "🧱", t: "Frontera" }, { e: "🌊", t: "Orilla" }], correcta: 0 },
  { ctx: "⏳", enunciado: "Lo que ocurrió hace mucho tiempo es el…", pista: "Lo estudiamos para saber de dónde venimos.",
    opciones: [{ e: "⏳", t: "Pasado" }, { e: "🔮", t: "Futuro" }, { e: "🎁", t: "Regalo" }], correcta: 0 },
  { ctx: "🤝", enunciado: "Para vivir bien con los demás debemos…", pista: "Tratar a todos con respeto.",
    opciones: [{ e: "😡", t: "Pelear" }, { e: "🤝", t: "Respetar" }, { e: "🙈", t: "Ignorar" }], correcta: 1 },
  { ctx: "🌎", enunciado: "El planeta donde vivimos se llama…", pista: "Es azul y redondo.",
    opciones: [{ e: "🌙", t: "Luna" }, { e: "☀️", t: "Sol" }, { e: "🌎", t: "Tierra" }], correcta: 2 },
  { ctx: "🚦", enunciado: "¿Qué debemos respetar para cruzar la calle?", pista: "Rojo detiene, verde deja pasar.",
    opciones: [{ e: "🚦", t: "Semáforo" }, { e: "🎈", t: "Globo" }, { e: "📺", t: "Tele" }], correcta: 0 },
  { ctx: "👮", enunciado: "¿Quién cuida el orden en la ciudad?", pista: "Usa uniforme y nos protege.",
    opciones: [{ e: "👮", t: "Policía" }, { e: "🤡", t: "Payaso" }, { e: "🧑‍🍳", t: "Cocinero" }], correcta: 0 },
  { ctx: "🏞️", enunciado: "Ríos, montañas y bosques son parte de la…", pista: "Todo lo natural que nos rodea.",
    opciones: [{ e: "📱", t: "Pantalla" }, { e: "🏞️", t: "Naturaleza" }, { e: "🎮", t: "Consola" }], correcta: 1 },
  { ctx: "🏫", enunciado: "El lugar donde aprendemos con maestros es la…", pista: "Vas cada día con tu mochila.",
    opciones: [{ e: "🏥", t: "Hospital" }, { e: "🏪", t: "Tienda" }, { e: "🏫", t: "Escuela" }], correcta: 2 },
];

// Memoria de preguntas recientes (localStorage) para no repetir entre cargas/
// niños en el mismo navegador. Recuerda los últimos 8 índices vistos.
const RECENT_KEY = "edinun_soc_demo_recientes_v1";   // ← PERSONALIZAR por juego
...
function GameScreen({ app, setApp, go }) {
  ...
  const [rounds, setRounds] = useStateG(() => pickRounds(ROUNDS));
  ...
  function confirmRestart() {
    ...
    const nuevas = pickRounds(ROUNDS);
    pushRecent(nuevas);
    setRounds(nuevas);
  ...
  function answerTap(i) {
    ...
    const entry = {
      ...
      emoji: q.ctx,
      a: q.enunciado,
      userAnswer: `${q.opciones[i].e} ${q.opciones[i].t}`,
      correctAnswer: `${correcta.e} ${correcta.t}`,
      isCorrect,
      time: exSec,
    };
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      {/* ── RONDA con dots (sin chip de tema: juego de 1 solo nivel) ── */}
      ...
      <div style={{ position: "absolute", left: 8, bottom: 78, width: 220, pointerEvents: "none", textAlign: "center" }}>
        <div className="ed-float-soft" style={{ position: "absolute", left: 0, right: 0, bottom: "100%", display: "flex", justifyContent: "center", pointerEvents: "none" }}>
          <div style={{
            ...
            {answered ? (picked === q.correcta ? "¡Muy bien!" : "¡Casi! Mira la respuesta.") : (q.pista || "Toca al correcto.")}
      ...
      <div style={{ position: "absolute", top: 60, bottom: 18, left: 215, right: 215, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-evenly" }}>
        ...
        {/* Cartel del emoji de contexto */}
        <div style={{
          width: 130, height: 116, borderRadius: 20,
          ...
          display: "flex", alignItems: "center", justifyContent: "center", fontSize: 82, lineHeight: 1,
        }}>
          {q.ctx}
        </div>

        {/* Opciones — fichas grandes tocables */}
          ...
          {q.opciones.map((op, i) => {
            ...
            return (
              <button
                ...
                disabled={answered}
                style={{
                  width: 128, height: 128, borderRadius: 18,
