...
// Arreglo de rondas del Tema 2. Empieza con R1; R2 (arrastrar a la selva) y R3 (ubicar en
// el mapa) se suman aquí a medida que se construyen. `verify` = usa el botón ¡VERIFICAR!.
const L5T2_ROUNDS = [
