    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.6em" }}>🗺️</span>
          ...
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.5em" }}>🏔️</span>
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        <span style={{ left: "5%", top: "10%", "--rot": "-8deg", fontSize: "0.72em" }}>🗺️</span>
        <span style={{ left: "84%", top: "6%", "--rot": "6deg", fontSize: "0.64em" }}>🧭</span>
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.62em" }}>📍</span>
        ...
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.5em" }}>🏞️</span>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          ...
          <div style={{
            ...
            Conoce las 24 provincias del Ecuador.
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    // Juego de nivel único: una sola temática (las 24 provincias del Ecuador).
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "provincias",
      currentCatLabel: "Provincias del Ecuador",
    }));
    go("game");
  }
