...
// ─────────────────────────────────────────────────────────────
// Fondo cósmico + glifos flotantes — los TRES temas del juego, no solo la geografía:
//   · T1/T2 continentes y relieve/hidrografía → 🌍 🌏 🌎 🗺️ 🧭 ⛰️ 🏔️ 🌊 💧 🏜️ 📊
//   · T3 diversidad cultural → 🎭 (fiestas) · ☯️ (Taegeuk) · 🎨 (Holi, los colores)
// ⚠ Se diseñaron con solo el Tema 1 hecho y quedaron 100 % geográficos; los culturales
// entraron ocupando el sitio de los DUPLICADOS (había 🌍×2, 🗺️×2, ★×2), sin mover ninguna
// posición ni cambiar el número de glifos (cosmic 15 · chalkboard 10).
// ─────────────────────────────────────────────────────────────
    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          ...
          <span style={{ left: "45%", top: "8%", "--rot": "4deg", fontSize: "0.5em" }}>☯️</span>
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.52em" }}>☯️</span>
