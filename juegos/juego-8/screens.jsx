    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          {/* Glifos del tema "trabajo / actividades económicas": moneda (el dólar del Ecuador),
              herramientas, engranaje, balanza. `︎` = presentación de TEXTO (monocromo, no emoji). */}
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.7em" }}>$</span>
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.65em" }}>{"⚙︎"}</span>
          <span style={{ left: "10%", top: "78%", "--rot": "12deg", fontSize: "0.7em" }}>{"⚒︎"}</span>
          <span style={{ left: "88%", top: "72%", "--rot": "-10deg", fontSize: "0.7em" }}>%</span>
          <span style={{ left: "45%", top: "8%", "--rot": "4deg", fontSize: "0.55em" }}>¢</span>
          <span style={{ left: "3%", top: "45%", "--rot": "-4deg", fontSize: "0.7em" }}>{"✎︎"}</span>
          <span style={{ left: "92%", top: "45%", "--rot": "8deg", fontSize: "0.65em" }}>{"⚖︎"}</span>
          <span style={{ left: "30%", top: "55%", "--rot": "-6deg", fontSize: "0.5em" }}>{"⌂"}</span>
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.5em" }}>{"✂︎"}</span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#4fd8ff", marginBottom: 8 }}>
              EDINUN · Estudios Sociales {/* ← PERSONALIZAR: tema del juego */}
            </div>
          ...
          <div style={{
            ...
            Descubre en qué trabajan las personas del Ecuador. {/* ← PERSONALIZAR: subtítulo corto */}
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  // Guía por defecto del juego-8: Andi. (app.jsx del shell arranca en "domi"; aquí se
  // preselecciona Andi en la primera visita, pero se respeta cualquier elección previa.)
  const [sel, setSel] = useState(app.character && app.character !== "domi" ? app.character : "andi");
  ...
  function choose() {
    ...
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "trabajo",
      currentCatLabel: "El trabajo de las personas",
    }));
    go("game");
  }
