    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.62em" }}>♻️</span>
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.64em" }}>🗑️</span>
        ...
        <span style={{ left: "32%", top: "70%", "--rot": "8deg", fontSize: "0.56em" }}>♻️</span>
...
function HomeScreen({ app, setApp, go }) {
  ...
  const initial = app.level && LEVELS_CFG.some((l) => l.id === app.level && l.enabled) ? app.level : "reciclaje";
...
function CharacterScreen({ app, setApp, go }) {
  const [sel, setSel] = useState("sisa"); // ← Sisa SIEMPRE preseleccionada (le toca el juego-3)
