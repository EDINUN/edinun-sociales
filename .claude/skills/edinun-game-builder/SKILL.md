...
| 6 | **El bloque "Ronda" va en `top:52`, `ed-label` fontSize 11, dots 11×11** (§1.1). No inventar formato propio. **Excepción (2026-09-23):** si el HUD lleva pastillas de tema, baja a `top:74` (§1.2) — el 52 es anterior a esas pastillas y las deja pegadas. | Se puso en `top:74` con dots 7×7 en un juego SIN pastillas. Y al revés: juego-10 se quedó en 52 teniéndolas, y la autora lo cazó (*"no está bien distribuido"*). → Ambos casos los chequea `format-lint.js`. |
